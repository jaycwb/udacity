...
var myFormatterLitros =  localeFormatter.numberFormat(",.3r");
...
function legend(variavelAlvo, dadosGeo){
    if(variavelAlvo == "Óleos Lubrificantes para Aviação") {
        ...
        var domainArray = [];
        dadosGeo.features.forEach(function(v){
            domainArray.push(v.properties[variavelAlvo]/1000)
        })
...
function highlight(data){
    ...
    if(variavelAlvo != "Óleos Lubrificantes para Aviação") {
        ...
        var stringVolume = String(myFormatter(prop_estado[variavelAlvo]/1000))
        var conteudo_legenda = "<h1>"+stringVolume+" m³"+"</h1><br>"
    } else {
        var nome_legenda = prop_estado.nome;
        var stringVolume = String(myFormatterLitros(prop_estado[variavelAlvo]))
        var conteudo_legenda = "<h1>"+stringVolume+" L"+"</h1><br>"
    }
